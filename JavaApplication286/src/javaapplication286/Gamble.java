...
public class Gamble extends GameBase implements IGame {
    ...
    public void pick() {
        ...
        if (userchoice == 1 && newnumber > number) {
            System.out.println("Correct (" + newnumber + ")");
        } else if (userchoice == 2 && newnumber < number) {
            System.out.println("Correct (" + newnumber + ")");
        } else if (userchoice == 3 && newnumber == number) {
            System.out.println("Correct (" + newnumber + ")");
        } else {
            System.out.println("Incorrect (" + newnumber + ")");
        }
        System.out.println("");
    }
;
