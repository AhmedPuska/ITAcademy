...
//        FileOutputStream fos = new FileOutputStream(pictureName);
        FileOutputStream fos = new FileOutputStream("C:/Users/user/Documents/rad/java vjezbe/WebApplication15/build/web/" + pictureName);
        while ((bajt=is.read())!=-1) {
            fos.write(bajt);
        }
        fos.close();
        
        response.getOutputStream().write(("<br><img src='" + pictureName + "' />").getBytes());
    }
