...
public class MessageServelt extends HttpServlet {
    ...
    private ConnectionFactory con_factory;
...
//    
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        con = con_factory.createConnection();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MessageServelt</title>");            
            out.println("</head>");
            out.println("<body>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(MessageServelt.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
