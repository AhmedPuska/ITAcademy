...
public class Products extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                Criteria criteria = sesija.createCriteria(Hero.class);
            ...
            for (Hero hero : heroes) {
                ...
                out.println("<img src='" + hero.picture + "' width='200' /><br>");
                out.println("<a href='details?id=" + hero.getId() + "'> Detalji...</a><hr><br>");
            }
            out.println("</body>");
            out.println("</html>");
        }
