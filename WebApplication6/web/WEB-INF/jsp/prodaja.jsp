<%@page contentType="text/html" pageEncoding="UTF-8"%>  
  ...
  <html>  
    <head>  
      ...
      <title>Prodaja - Web Prodavnica</title>  
      <style>  
    ...
    <body>  
      ...
      <textarea id="svi_kupci" rows="15" cols="40" readonly>${kupcis}</textarea> 
      <h3 id="proizvodiT">Proizvodi:</h3>
      <textarea id="lista_proizvoda" rows="15" cols="40" readonly>${proizvodis}</textarea>  <br>
