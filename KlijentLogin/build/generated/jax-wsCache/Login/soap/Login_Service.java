 ...
 * 
 */
@WebServiceClient(name = "Login", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8080/LoginSystem/Login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGIN_QNAME = new QName("http://soap/", "Login");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/LoginSystem/Login?wsdl");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://soap/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap/", "LoginPort"), Login.class, features);
    }
